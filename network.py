...
class U_Net(nn.Module):
    def __init__(self,img_dim,output_ch=1):
        ...
        self.Conv1 = conv_block(ch_in=img_dim,ch_out=64)
...
class AttU_Net(nn.Module):
    def __init__(self,img_dim,output_ch=1, features=32): #org 64
        ...
        self.fc = nn.Linear(features*16*4, 256) 
        ...
        self.Conv_1x1 = nn.Conv2d(features,output_ch,kernel_size=1,stride=1,padding=0)
...
class R2AttU_Net(nn.Module):
    def __init__(self,img_dim, output_ch=1,t=2):
        ...
        self.RRCNN5 = RRCNN_block(ch_in=512,ch_out=1024,t=t)
        #self.fc1 = nn.Linear(2048*16*16, 256)
